...
async function main() {
  ...
  await prisma.table.createMany({
    data: [
      { establishmentId: demoEstablishment.id, number: '1', capacity: 4, status: 'AVAILABLE' },
      { establishmentId: demoEstablishment.id, number: '2', capacity: 4, status: 'AVAILABLE' },
      { establishmentId: demoEstablishment.id, number: '3', capacity: 6, status: 'AVAILABLE' },
      { establishmentId: demoEstablishment.id, number: '4', capacity: 2, status: 'AVAILABLE' },
      { establishmentId: demoEstablishment.id, number: '5', capacity: 8, status: 'AVAILABLE' },
    ],
  });
