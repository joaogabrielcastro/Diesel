...
export class ProductsController {
  ...
  create(@Request() req, @Body() createProductDto: CreateProductDto) {
    return this.productsService.create(req.user.establishmentId, createProductDto);
  }
  ...
  update(
    ...
    return this.productsService.update(id, req.user.establishmentId, updateProductDto);
  }
